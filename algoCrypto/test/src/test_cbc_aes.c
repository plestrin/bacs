...
int main(){
	char 			plaintext[] = "Hi I am an AES CBC test vector distributed on 5 128-bit blocks!";
	...
	mode_enc_cbc((blockCipher)aes128_encrypt, AES_BLOCK_NB_BYTE, (uint8_t*)plaintext, (uint8_t*)ciphertext, sizeof(plaintext), (void*)round_key_128, (uint8_t*)iv);
