...
int main(void){
	...
	aes128.set_key(key_128, sizeof key_128);
	aes128.encrypt_n(pt, ct, 1);
	aes128.decrypt_n(ct, vt, 1);
	...
	aes192.set_key(key_192, sizeof key_192);
	aes192.encrypt_n(pt, ct, 1);
	aes192.decrypt_n(ct, vt, 1);
	...
	aes256.set_key(key_256, sizeof key_256);
	aes256.encrypt_n(pt, ct, 1);
	aes256.decrypt_n(ct, vt, 1);
