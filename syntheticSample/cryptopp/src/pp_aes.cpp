...
int main(void){
	...
	/* 128 */
	CryptoPP::ECB_Mode<CryptoPP::AES>::Encryption ecb_enc_aes128(key128, sizeof key128);
	ecb_enc_aes128.ProcessData(ct, pt, sizeof pt);
	...
	CryptoPP::ECB_Mode<CryptoPP::AES>::Decryption ecb_dec_aes128(key128, sizeof key128);
	ecb_dec_aes128.ProcessData(vt, ct, sizeof ct);
	...
	/* 192 */
	CryptoPP::ECB_Mode<CryptoPP::AES>::Encryption ecb_enc_aes192(key192, sizeof key192);
	ecb_enc_aes192.ProcessData(ct, pt, sizeof pt);
	...
	CryptoPP::ECB_Mode<CryptoPP::AES>::Decryption ecb_dec_aes192(key192, sizeof key192);
	ecb_dec_aes192.ProcessData(vt, ct, sizeof ct);
	...
	/* 256 */
	CryptoPP::ECB_Mode<CryptoPP::AES>::Encryption ecb_enc_aes256(key256, sizeof key256);
	ecb_enc_aes256.ProcessData(ct, pt, sizeof pt);
	...
	CryptoPP::ECB_Mode<CryptoPP::AES>::Decryption ecb_dec_aes256(key256, sizeof key256);
	ecb_dec_aes256.ProcessData(vt, ct, sizeof ct);
