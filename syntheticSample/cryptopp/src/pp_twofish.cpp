...
int main() {
	...
	/* TWOFISH 128 */
	CryptoPP::ECB_Mode<CryptoPP::Twofish>::Encryption ecb_enc_twofish128(key128, 16);
	ecb_enc_twofish128.ProcessData(ct, pt, 16);
	...
	CryptoPP::ECB_Mode<CryptoPP::Twofish>::Decryption ecb_dec_twofish128(key128, 16);
	ecb_dec_twofish128.ProcessData(vt, ct, 16);
	...
	/* TWOFISH 192 */
	CryptoPP::ECB_Mode<CryptoPP::Twofish>::Encryption ecb_enc_twofish192(key192, 24);
	ecb_enc_twofish192.ProcessData(ct, pt, 16);
	...
	CryptoPP::ECB_Mode<CryptoPP::Twofish>::Decryption ecb_dec_twofish192(key192, 24);
	ecb_dec_twofish192.ProcessData(vt, ct, 16);
	...
	/* TWOFISH 256 */
	CryptoPP::ECB_Mode<CryptoPP::Twofish>::Encryption ecb_enc_twofish256(key256, 32);
	ecb_enc_twofish256.ProcessData(ct, pt, 16);
	...
	CryptoPP::ECB_Mode<CryptoPP::Twofish>::Decryption ecb_dec_twofish256(key256, 32);
	ecb_dec_twofish256.ProcessData(vt, ct, 16);
