...
ckeck_list = [
	...
	[
		...
		r'openssl/build/open_md5',
		r'cryptopp/build/pp_md5',
	...
	[
		...
		r'openssl/build/open_rc4',
		r'cryptopp/build/pp_rc4',
	...
	[
		...
		r'cryptopp/build/pp_cbc_aes'
	],

	# AES OFB
	[
		r'test/build/test_ofb_aes_[gc]o[0-9sz]',
		r'openssl/build/open_ofb_aes',
	...
	# AES CTR (endianess 2)
	[
		r'openssl/build/open_ctr_aes',
		r'botan/build/bot_ctr_aes',
		r'cryptopp/build/pp_ctr_aes'
	],

	# SHA1
	[
		r'test/build/test_sha1_[gc]o[0-9sz]',
		r'openssl/build/open_sha1',
		r'cryptopp/build/pp_sha1',
	...
	[
		...
		r'openssl/build/open_des',
		r'cryptopp/build/pp_des',
